            ...
            <div class="max-w-2xl mx-auto px-8 py-12 relative z-10">
                ...
                <div class="mb-12 animate-slide-up" style="animation-delay: 0.4s;">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="https://github.com/vanguardbackup/vanguard" target="_blank" rel="noopener noreferrer" class="bg-white text-gray-900 hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold transition duration-300 hover-scale flex items-center shadow-md">
