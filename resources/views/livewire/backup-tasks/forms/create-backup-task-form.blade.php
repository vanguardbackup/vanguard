                            ...
                            <div wire:transition>
                                <div class="mt-4 flex space-x-6">
                                    <div class="w-3/6">
                                        ...
                                        <x-input-explain>
                                            {{ __('Please enter the username assigned to your site in Ploi or Laravel Forge.') }}
                                        </x-input-explain>
                                    </div>
                                    <div class="w-3/6">
                                        ...
                                        <x-input-explain>
                                            {{ __('Please provide the isolated site password generated by Ploi or Laravel Forge.') }}
                                        </x-input-explain>
                                    </div>
                                </div>
                            </div>
