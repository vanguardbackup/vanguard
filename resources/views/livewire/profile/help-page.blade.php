            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                @foreach ($resources as $resource)
                    <a href="{{ $resource['url'] }}" class="group block" target="_blank" rel="noopener noreferrer">
                        <div
                            class="h-full flex flex-col p-4 sm:p-6 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 transition duration-300 ease-in-out hover:bg-gray-100 dark:hover:bg-gray-700 hover:shadow-md">
                            <div class="flex items-center mb-3 sm:mb-4">
                                <x-dynamic-component :component="$resource['icon']"
                                                     class="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 dark:text-gray-400 transition-transform duration-300 ease-in-out transform group-hover:scale-110"/>
                            ...
                            <div
                                class="mt-3 sm:mt-4 flex items-center text-gray-900 dark:text-white text-xs sm:text-sm font-medium underline">
                                {{ __('Learn more') }}
                                <x-hugeicons-arrow-right-02
                                    class="ml-1 w-3 h-3 sm:w-4 sm:h-4 transition-transform duration-300 ease-in-out transform group-hover:translate-x-1"/>
                            </div>
                        </div>
                    </a>
                @endforeach
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
                ...
                <ul class="space-y-3 text-sm sm:text-base text-gray-700 dark:text-gray-300">
                    <li class="flex flex-wrap items-center">
                        ...
                        <a href="mailto:support@vanguardbackup.com"
                           class="ml-1 sm:ml-2 text-gray-900 dark:text-white hover:underline underline">support@vanguardbackup.com</a>
                        <span
                            class="w-full sm:w-auto sm:ml-2 mt-1 sm:mt-0 text-xs italic text-gray-500 dark:text-gray-400">({{ __('for urgent issues') }})</span>
                    </li>
                    <li class="flex items-center">
                        ...
                        <a href="mailto:hello@vanguardbackup.com"
                           class="ml-1 sm:ml-2 text-gray-900 dark:text-white hover:underline underline">hello@vanguardbackup.com</a>
                    </li>
                </ul>
            </div>
        </div>
