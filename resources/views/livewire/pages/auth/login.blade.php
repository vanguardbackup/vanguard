...
<div>
    ...
    <form wire:submit="login">
        ...
        <div>
            ...
            <x-text-input wire:model="form.email" id="email" class="block mt-2.5 w-full" type="email" name="email" autofocus autocomplete="email" />
                ...
                <div>
                    <div class="inline-flex items-center mt-1">
                        @if (Route::has('password.request'))
                            <a class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-offset-gray-800" href="{{ route('password.request') }}" wire:navigate>
       ...
       <div class="flex justify-evenly mt-2">
        ...
        <div class="text-center mt-5 my-3">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="{{ route('register') }}" class="font-medium text-primary-600 dark:text-primary-400 hover:text-primary-500 dark:hover:text-primary-300" wire:navigate>
                    {{ __('Sign Up') }}
                </a>
            </div>
        </div>
